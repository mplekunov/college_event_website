...
const authenticationController = new AuthenticationController_1.default(userDatabase, new Encryptor_1.default(), new TokenCreator_1.default(privateKey), new UniversityController_1.default(universityDatabase));
