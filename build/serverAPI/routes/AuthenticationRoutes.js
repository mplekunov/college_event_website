...
const authenticationController = new AuthenticationController_1.default(UserDatabase_1.default.connect(databaseURL, databaseName, username, password), new Encryptor_1.default(), new TokenCreator_1.default(privateKey));
